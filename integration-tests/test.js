...
describe('Upload File', () => {
  ...
  it('Share file', async () => {
    ...
    let tx = await access.share([did], ["0x9CC14A288BB5cb9Ec0e85b606Cb6585BB7ca6a8E"], [150]);
  ...
  //   console.log('did', did);
  //   let metadataURL = await nftArcana.makeMetadataURL(
  //     'Random title',
  ...
  //   let oMetadata = await (await fetch(metadataURL)).json();
  ...
  //   };
  //   upload.onProgress = (a, b) => {
  //     console.log(a, b);
  //   };
  //   let tx = await upload.upload(file);
  //   chai.expect(tx).not.null;
  // })
